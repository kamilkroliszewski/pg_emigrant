...
7. Ownership synchronization for tables, sequences, and schemas (`ALTER ... OWNER TO`)
8. Create publication on source
9. Create subscription on target (without re-copying data)
